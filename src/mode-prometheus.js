// jshint ignore: start
// jscs: disable
ace.define("ace/mode/ScopedPrometheus_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
    "use strict";
    
    var oop = require("../lib/oop");
    var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
    
    var ScopedPrometheusHighlightRules = function() {
      var keywords = (
    ...
    oop.inherits(ScopedPrometheusHighlightRules, TextHighlightRules);
    
    exports.ScopedPrometheusHighlightRules = ScopedPrometheusHighlightRules;
    });
    
    ace.define("ace/mode/ScopedPrometheus_completions",["require","exports","module","ace/token_iterator", "ace/lib/lang"], function(require, exports, module) {
    "use strict";
    
    var lang = require("../lib/lang");
    
    var ScopedPrometheusKeyWords = [
    ...
    var keyWordsCompletions = ScopedPrometheusKeyWords.map(function(word) {
      return {
        caption: word,
        value: word,
        meta: "keyword",
    ...
    var functionsCompletions = ScopedPrometheusFunctions.map(function(item) {
      return {
        caption: item.name,
        value: item.value,
    ...
    var ScopedPrometheusCompletions = function() {};
    ...
    }).call(ScopedPrometheusCompletions.prototype);
    
    exports.ScopedPrometheusCompletions = ScopedPrometheusCompletions;
    });
    
    ace.define("ace/mode/behaviour/ScopedPrometheus",["require","exports","module","ace/lib/oop","ace/mode/behaviour","ace/mode/behaviour/cstyle","ace/token_iterator"], function(require, exports, module) {
    "use strict";
    ...
    var ScopedPrometheusBehaviour = function () {
    ...
    oop.inherits(ScopedPrometheusBehaviour, CstyleBehaviour);
    
    exports.ScopedPrometheusBehaviour = ScopedPrometheusBehaviour;
    });
    
    ace.define("ace/mode/ScopedPrometheus",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/ScopedPrometheus_highlight_rules"], function(require, exports, module) {
    "use strict";
    
    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var ScopedPrometheusHighlightRules = require("./ScopedPrometheus_highlight_rules").ScopedPrometheusHighlightRules;
    var ScopedPrometheusCompletions = require("./ScopedPrometheus_completions").ScopedPrometheusCompletions;
    var ScopedPrometheusBehaviour = require("./behaviour/ScopedPrometheus").ScopedPrometheusBehaviour;
    
    var Mode = function() {
      this.HighlightRules = ScopedPrometheusHighlightRules;
      this.$behaviour = new ScopedPrometheusBehaviour();
      this.$completer = new ScopedPrometheusCompletions();
    ...
    (function() {
      ...
      this.$id = "ace/mode/ScopedPrometheus";
    }).call(Mode.prototype);
