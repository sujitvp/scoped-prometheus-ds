...
describe('ScopedPrometheusDatasource', function() {
  ...
  describe('When querying ScopedPrometheus with one target using query editor target spec', function() {
    var results;
    var urlExpected =
  ...
  describe('When querying ScopedPrometheus with one target which return multiple series', function() {
    var results;
  ...
  describe('When querying ScopedPrometheus with one target and instant = true', function() {
    var results;
